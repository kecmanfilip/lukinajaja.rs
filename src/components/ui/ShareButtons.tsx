...
export function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-sm text-foreground-light flex items-center gap-1">
      ...
      <a
        ...
        aria-label="Podelite na WhatsApp"
      >
      ...
      {copied && (
        <span className="text-xs text-primary font-medium">Kopirano!</span>
      )}
    </div>
  );
}
